...
public class PassProductSeedService {
    ...
    private static final List<DefaultPassProduct> DEFAULT_PRODUCTS = List.of(
            DefaultPassProduct.of("커피 PASS", 5000, "커피 마시고 싶은 마음을 꾹 참고 저축해볼까요?"),
            DefaultPassProduct.of("배달 PASS", 20000, "배달 시키고 싶은 마음을 꾹 참고 저축해볼까요?"),
            DefaultPassProduct.of("택시 PASS", 10000, "택시 타고 싶은 마음을 꾹 참고 저축해볼까요?"),
            DefaultPassProduct.of("쇼핑 PASS", 15000, "충동구매 하고 싶은 마음을 꾹 참고 저축해볼까요?"),
            DefaultPassProduct.of("편의점 PASS", 3000, "편의점에서 사고 싶은 마음을 꾹 참고 저축해볼까요?"),
            DefaultPassProduct.of("술 PASS", 30000, "한 잔 하고 싶은 마음을 꾹 참고 저축해볼까요?")
    );
    ...
    private record DefaultPassProduct(
            String name,
            Integer amountPerSave,
            String description
    ) {
        private static DefaultPassProduct of(
                final String name,
                final Integer amountPerSave,
