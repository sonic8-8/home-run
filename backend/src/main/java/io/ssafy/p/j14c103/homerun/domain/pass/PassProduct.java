...
public class PassProduct {
    ...
    private PassProduct(final String name, final String description) {
        this.name = name;
        this.description = description;
    }

    public static PassProduct create(final String name, final String description) {
        ...
        return new PassProduct(name, description);
    }
}
