...
class SecurityConfigTest {
    ...
    private static Stream<Arguments> protectedPaths() {
        return Stream.of(
                ...
                Arguments.of("/api/home/dashboard?userKey=ssafy-user-key"),
                Arguments.of("/api/pass/subscriptions?userId=1"),
                Arguments.of("/api/seedmoney/account?userId=1&userKey=ssafy-user-key"),
                Arguments.of("/api/credit/score?userId=1&userKey=ssafy-user-key"),
