...
class StockOrderTest {
    ...
    @Test
    void createBuyOrder() {
        final StockOrder order = StockOrder.createBuyOrder(1L, "SAMSUNG", 5, 3);

        assertThat(order.getGameSessionId()).isEqualTo(1L);
    ...
    void createSellOrder() {
        final StockOrder order = StockOrder.createSellOrder(1L, "KAKAO", 10, 5);
