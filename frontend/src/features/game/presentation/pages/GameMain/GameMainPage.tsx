...
export function GameMainPage() {
  ...
  const [isNewsOpenedManually, setIsNewsOpenedManually] = useState(false);
  const newsStorageKey =
    sessionId !== null ? `news_seen_date_${sessionId}` : null;
  const shouldAutoOpenNews =
    newsStorageKey !== null &&
    currentDate !== null &&
    sessionStorage.getItem(newsStorageKey) !== currentDate;
  const isNewsOpen = isNewsOpenedManually || shouldAutoOpenNews;
    ...
    <>
          ...
          <div className={styles.panel}>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.menuList}>
                ...
                <button
                  className={styles.menuButton}
                  onClick={() => setIsNewsOpenedManually(true)}
                >
                  이달의 뉴스
                </button>
              </div>
      ...
      {sessionId !== null && (
        <NewsEventModal
          isOpen={isNewsOpen}
          onClose={() => {
            if (newsStorageKey !== null && currentDate !== null) {
              sessionStorage.setItem(newsStorageKey, currentDate);
            }
            setIsNewsOpenedManually(false);
          }}
          sessionId={sessionId}
        />
      )}
