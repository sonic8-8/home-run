  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.formSection}>
        ...
        <button
          className={`${styles.optionBtn} ${method === 'mydata' ? styles.selected : ''}`}
        ...
        <button
          className={`${styles.optionBtn} ${method === 'job' ? styles.selected : ''}`}
        ...
        <button
          className={`${styles.nextBtn} ${method ? styles.active : ''}`}
          onClick={handleNext}
          disabled={!method}
        >
          NEXT &gt;
