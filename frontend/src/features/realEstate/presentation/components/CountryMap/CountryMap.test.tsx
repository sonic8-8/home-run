...
vi.mock('react-simple-maps', () => ({
  ...
  Geographies: ({
    ...
    children({
      geographies: [
        { rsmKey: 'seoul', properties: { name: '서울특별시' }, geometry: { coordinates: [[[126.9, 37.5]]] } },
        { rsmKey: 'gwangju', properties: { name: '광주광역시' }, geometry: { coordinates: [[[126.8, 35.1]]] } },
        { rsmKey: 'sejong', properties: { name: '세종특별자치시' }, geometry: { coordinates: [[[127.2, 36.5]]] } },
...
describe('CountryMap', () => {
  it('서울과 광주만 국가 지도에서 노출한다', () => {
    ...
    expect(screen.getByTestId('country-region-29')).toBeInTheDocument();
